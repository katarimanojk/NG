...
- RHOCP: single node crc (codre ready containers) where single vm works as both master and worker for k8s (All-in-one)
  see [rhocp_deployment_using crc](https://github.com/katarimanojk/NG/blob/main/docs/osp18_deployment_option_crc.md)
- RHOSO: install_yamls make files
  see [rhoso_deployment_using install_yamls](https://github.com/katarimanojk/NG/blob/main/docs/osp18_deployment_option_install_yamls.md)
...
- RHOCP:  kcli or m3 dev scripts 
  ...
  - kcli : mutlininode ocp 
    ...
    ```
  refer:
   - Alan's kcli doc : https://github.com/katarimanojk/NG/blob/main/docs/rhoso-kcli.org
   - for rhoso-cluster.yml see https://github.com/katarimanojk/NG/blob/main/docs/rhoso-cluster.yml
