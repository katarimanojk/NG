...
Ceph public network is  storage network (cinder,manila, glance interact )
Ceph cluster netwrok is  stroage_mgnt netowrk ( storage backend like cephrbd, nfs, pure network)
